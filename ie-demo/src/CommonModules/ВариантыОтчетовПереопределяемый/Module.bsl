...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы(), НСтр("ru = 'Библиотека отчетов'"));
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.КонтрагентыПоМенеджерам, "Основной");
	НастройкиВарианта.Размещение.Вставить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы());
	НастройкиВарианта.Описание = 
		"Демонстрация своей иерархии
		|через соединение набора данных самого с собой";
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ПродажиОстаткиЦены, "Основной");
	НастройкиВарианта.Размещение.Вставить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы());
	НастройкиВарианта.Описание = 
		"Демонстрация получения среза последних и остатков
		|на разные даты через соединение наборов данных";
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ПродажиУниверсальный, "Основной");
	НастройкиВарианта.Размещение.Вставить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы());
	НастройкиВарианта.Описание = 
		"Демонстрация настройки связей параметров выбора";
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ПродажиУниверсальный, "ПримерПользовательскихПолей");
	НастройкиВарианта.Размещение.Вставить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы());
	НастройкиВарианта.Описание = 
		"Демонстрация настройки пользовательских полей
		|с аргератными функциями и вычислением выражений";
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.КонтрагентыПоМенеджерамРегистр, "Основной");
	НастройкиВарианта.Размещение.Вставить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы());
	НастройкиВарианта.Включен = Ложь;
